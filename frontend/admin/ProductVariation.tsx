...
import {ProductVariationDialog} from "./dialogs/ProductVariationDialog";
...
export const ProductVariation = () => {
    ...
    return <Grid className="p-4">
        <Grid container>
            <Grid item xs>
                <Typography variant="h5" className="font-weight-normal">Product Variation
                </Typography>
            </Grid>
            <Grid item xs className="d-flex justify-content-end" alignItems="center">
                <Button
                    startIcon={<Add/>} color="primary" className="text-white" style={{fontSize: 13}} variant="contained"
                    size="small"
